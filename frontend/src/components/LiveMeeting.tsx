...
export function LiveMeeting({ onExit }: LiveMeetingProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900">
      {/* Top Bar */}
      <div className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm border-b border-slate-200 dark:border-slate-700">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <div className="size-3 bg-red-500 rounded-full animate-pulse" />
                <span className="text-slate-900 dark:text-white">Live Meeting</span>
              </div>
            ...
            <div className="flex items-center gap-3">
              <Button variant="ghost" className="text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-700">
