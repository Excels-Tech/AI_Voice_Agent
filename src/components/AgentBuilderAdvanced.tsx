        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-slate-900">Create Advanced Agent</h1>
              ...
              <div key={s.num} className="flex items-center flex-1">
                <div className="flex items-center gap-3">
                  ...
                  <div className="hidden md:block">
                    <p className={`text-sm ${step >= s.num ? "text-slate-900" : "text-slate-500"}`}>
                      {s.title}
                    </p>
                  </div>
                </div>
                {idx < 4 && (
                  <div className={`flex-1 h-0.5 mx-4 ${step > s.num ? "bg-blue-600" : "bg-slate-200"}`} />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              <Card className="bg-white border-slate-200">
                <CardHeader>
                  ...
                  <CardDescription>Set up fundamental agent settings</CardDescription>
                </CardHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        <p className="text-slate-900">Inbound</p>
                        <p className="text-slate-600 text-sm">Receive incoming calls</p>
                      </button>
                      <button
                      ...
                      >
                        ...
                        <p className="text-slate-900">Outbound</p>
                        <p className="text-slate-600 text-sm">Make outgoing calls</p>
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid md:grid-cols-3 gap-3">
                      ...
                      >
                        ...
                        <p className="text-slate-600 text-sm">Via Twilio</p>
                      </button>
                      <button
                      ...
                      >
                        ...
                        <p className="text-slate-900">WebRTC</p>
                        <p className="text-slate-600 text-sm">Browser calling</p>
                      </button>
                      <button
                      ...
                      >
                        ...
                        <p className="text-slate-600 text-sm">Phone + WebRTC</p>
                      </button>
                    </div>
                  </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <Card className="bg-white border-slate-200">
                <CardHeader>
                  <CardTitle>AI & Conversation Behavior</CardTitle>
                  <CardDescription>Configure LLM settings and conversation style</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="creativity">Answer Creativity: {agentData.answerCreativity}</Label>
                      <input
                        type="range"
                        id="creativity"
                        min="0"
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="contextLimit">Context Token Limit</Label>
                      <Input
                        type="number"
                        id="contextLimit"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="maxAnswer">Max Answer Length (words)</Label>
                      <Input
                        type="number"
                        id="maxAnswer"
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        className="rounded"
                      />
                      <Label htmlFor="scriptMode">Enable Script Mode (strict adherence)</Label>
                    </div>
            ...
            <div className="space-y-6">
              <Card className="bg-white border-slate-200">
                <CardHeader>
                  ...
                  <CardDescription>Configure voice, language, and speech detection</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                  ...
                  <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                    <p className="text-purple-900 mb-2">🎙️ Voice Cloning (ElevenLabs)</p>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="welcomeDelay">Welcome Message Delay (seconds)</Label>
                      <Input
                        type="number"
                        id="welcomeDelay"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="silenceTimeout">Auto-Hangup Silence (seconds)</Label>
                      <Input
                        type="number"
                        id="silenceTimeout"
                  ...
                  <div className="space-y-4">
                    <h4 className="text-slate-900">Speech Detection Controls</h4>
                    <div className="space-y-2">
                      <Label htmlFor="speechSensitivity">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-slate-50">
                      ...
                      />
                      <div>
                        <p className="text-slate-900">Transcribe Filler Words</p>
                        <p className="text-slate-600 text-sm">Include "um", "uh", etc. in transcript</p>
                      </div>
                    </label>
                    <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-slate-50">
                      <input
                      ...
                      />
                      <div>
                        <p className="text-slate-900">Silence Prompts</p>
                        <p className="text-slate-600 text-sm">Agent prompts on extended silence</p>
                      </div>
                    </label>
                    <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-slate-50">
                      <input
                      ...
                      />
                      <div>
                        <p className="text-slate-900">Auto-Hangup on Silence</p>
                        <p className="text-slate-600 text-sm">End call after silence timeout</p>
                      </div>
                    </label>
                  </div>
                  ...
                  {agentData.deploymentType !== "phone" && (
                    <div className="space-y-2">
                      <Label>Background Ambience (WebRTC only)</Label>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {[
                          ...
                          >
                            ...
                            <p className="text-slate-900 text-sm">{bg.name}</p>
                          </button>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <h4 className="text-slate-900">Voicemail & Machine Detection</h4>
                    <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-slate-50">
                      <input
                        type="checkbox"
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-sm">Detect answering machines</p>
                      </div>
                    </label>
                    ...
                    {agentData.voicemailDetection && (
                      <div className="space-y-4 ml-8">
                        <div className="space-y-2">
                          <Label htmlFor="machineTimeout">Detection Timeout (seconds)</Label>
                          <Input
                            type="number"
                            id="machineTimeout"
                        ...
                        {agentData.voicemailBehavior === "leave_message" && (
                          <div className="space-y-2">
                            <Label htmlFor="voicemailMsg">Voicemail Message</Label>
                            <Textarea
                              id="voicemailMsg"
            ...
            <div className="space-y-6">
              <Card className="bg-white border-slate-200">
                <CardHeader>
                  ...
                  <CardDescription>Upload files to train your agent</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  {agentData.knowledgeFiles.length > 0 && (
                    <div className="space-y-2">
                      <h4 className="text-slate-900">Uploaded Files</h4>
              ...
              <Card className="bg-white border-slate-200">
                <CardHeader>
                  <CardTitle>Actions & Integrations</CardTitle>
                  <CardDescription>Automate tasks during or after calls</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid md:grid-cols-3 gap-3">
                    <button
                    ...
                    >
                      ...
                      <p className="text-slate-900">Email Action</p>
                      <p className="text-slate-600 text-sm">Send emails</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-slate-900">SMS Action</p>
                      <p className="text-slate-600 text-sm">Send SMS</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-slate-900">Webhook</p>
                      <p className="text-slate-600 text-sm">HTTP POST</p>
                    </button>
                  </div>

                  {agentData.actions.length > 0 && (
                    <div className="space-y-2">
                      <h4 className="text-slate-900">Configured Actions</h4>
                      {agentData.actions.map((action) => (
                        <div key={action.id} className="p-3 border rounded-lg flex items-center justify-between">
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      <Zap className="size-6 text-purple-600 shrink-0 mt-1" />
                      <div>
                        <p className="text-purple-900 mb-2">Zapier Integration</p>
                        <p className="text-purple-700 text-sm mb-3">
              ...
              <Card className="bg-white border-slate-200">
                ...
                <CardContent className="space-y-4">
                  ...
                  <label className="flex items-center gap-3 p-4 border-2 border-yellow-200 bg-yellow-50 rounded-lg cursor-pointer hover:bg-yellow-100">
                    <input
                      type="checkbox"
                    ...
                    <div className="flex-1">
                      <p className="text-yellow-900 flex items-center gap-2">
                        ...
                        <Badge className="bg-yellow-600">Premium Add-on</Badge>
                      </p>
          ...
          {step === 5 && (
            <Card className="bg-white border-slate-200">
              <CardHeader>
                ...
                <CardDescription>Review and activate</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-green-900 mb-2">Advanced Agent Ready!</h3>
                      <p className="text-green-700 mb-4">
                        All CallFluent features configured
                      </p>
                      <div className="grid md:grid-cols-3 gap-4">
                        <div>
                          <p className="text-green-900 mb-1">Name</p>
                          <p className="text-green-700">{agentData.name || "Unnamed"}</p>
                        </div>
                        <div>
                          <p className="text-green-900 mb-1">Format</p>
                          <p className="text-green-700 capitalize">{agentData.format}</p>
                        </div>
                        <div>
                          <p className="text-green-900 mb-1">Model</p>
                          <p className="text-green-700">{agentData.openAIModel}</p>
                        </div>
                        <div>
                        ...
                        <div>
                          <p className="text-green-900 mb-1">Knowledge Files</p>
                          <p className="text-green-700">{agentData.knowledgeFiles.length}</p>
                        </div>
                        <div>
                          <p className="text-green-900 mb-1">Actions</p>
                          <p className="text-green-700">{agentData.actions.length}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <h4 className="text-slate-900">API Endpoint (Outbound Calls)</h4>
                ...
                {agentData.deploymentType !== "phone" && (
                  <div className="space-y-3">
                    <h4 className="text-slate-900">WebRTC Widget Code</h4>
                    <div className="p-4 bg-slate-900 rounded-lg">
...
></script>`}
                ...
                <div className="space-y-2">
                  <h4 className="text-slate-900">Features Enabled</h4>
                  <div className="grid md:grid-cols-2 gap-2">
                    <div className="flex items-center gap-2">
                      <Check className="size-4 text-green-500" />
                      <span className="text-slate-700">AI Model: {agentData.openAIModel}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Check className="size-4 text-green-500" />
                      <span className="text-slate-700">Voice: {agentData.voice}</span>
                    </div>
                    {agentData.voicemailDetection && (
                      <div className="flex items-center gap-2">
                        <Check className="size-4 text-green-500" />
                        <span className="text-slate-700">Voicemail Detection</span>
                      </div>
                    )}
                    {agentData.recordCalls && (
                      <div className="flex items-center gap-2">
                        <Check className="size-4 text-green-500" />
                        <span className="text-slate-700">Call Recording</span>
                      </div>
                    )}
                    ...
                    {agentData.maxLatencyOptimization && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-slate-700">Low Latency (~800ms)</span>
                      </div>
                    )}
                  </div>
                </div>
