        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white">
            <div className="flex justify-between items-start mb-6">
              <div>
                <p className="text-white/80 mb-2">Current Plan</p>
              ...
              <div className="flex items-center gap-2 bg-white/20 px-4 py-2 rounded-lg text-white">
                ...
                <span className="capitalize text-white">{currentPlan.status}</span>
              </div>
            </div>
            
            <div className="flex items-center gap-2 text-white/85">
              <Calendar className="w-4 h-4 text-white" />
              <span className="text-white/90">Next billing date: {new Date(currentPlan.nextBillingDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</span>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-3 mb-6">
              <div>
                ...
                <p className="text-gray-600">
                  Total spent: <span className="text-gray-900 font-medium">{formatCurrency(totalSpent)}</span> • {allInvoices.length} invoices
                </p>
              </div>
